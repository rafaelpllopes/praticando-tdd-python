...
def test_deve_subtrair_valor_da_carteira_usuairo_quando_este_propor_um_lance(vini, leilao):
    vini.propoe_lance(leilao, 50.0)
    assert vini.carteira == 50.0

def test_deve_permitir_propor_lance_quando_o_valor_eh_menor_que_valor_da_carteira(vini, leilao):
...
def test_deve_permitir_propor_lance_com_valor_maior_que_o_da_carteira(vini, leilao):
